...
class VisionTransformer(timm.models.vision_transformer.VisionTransformer):
    def __init__(self, cls_only=True, **kwargs):
...
def vit_mini_flex(img_size, in_chans, patch_size=4, **kwargs):
    model = VisionTransformer(img_size=img_size, in_chans=in_chans,
        patch_size=4, embed_dim=192, depth=4, num_heads=3, mlp_ratio=4,
